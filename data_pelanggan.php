...
$sql = "SELECT * FROM tbl_pelanggan ORDER BY nama_pelanggan ABC";
        ...
        <tr>
            ...
            <td>
                ...
                <a href = "hapus_pelanggan.php?id=<?php echo $row['id_pelanggan']; ?>"
                    onclick = "return confrim('Yakin hapus pelanggan ini?');">Hapus</a>
            </td>
        </tr>
        <?php } ?>
        </table>
